...
<body>
  ...
  <section id="home">
    <div class="container">
      ...
      <p>Cshop Offers the best products for the most affordable prices</p>
  ...
  <section id="brand" class="container">
    <div class="row">
      <img class="img-fluid col-lg-3 col-md-6 col-sm-12 " src="assets/imgs/bag3.jpg" alt="brand">
      <img class="img-fluid col-lg-3 col-md-6 col-sm-12 " src="assets/imgs/men-jeans.jpg" alt="brand">
      <img class="img-fluid col-lg-3 col-md-6 col-sm-12 " src="assets/imgs/shoe.jpg" alt="brand">
      <img class="img-fluid col-lg-3 col-md-6 col-sm-12 " src="assets/imgs/bag.jpg" alt="brand">
    </div>
  </section>
  ...
  <section id="new" class="w-100">
    <div class="row p-0 m-0">
      ...
      <div  class="one col-lg-4 col-md-12 col-sm-12 p-0">
        <img class="img-fluid" src="assets/imgs/shoe2.jpg" alt="">
        <div class="details">
      ...
      <!--Two-->
      <div  class="one col-lg-4 col-md-12 col-sm-12 p-0">
        <img class="img-fluid" src="assets/imgs/bag4.jpg" alt="jacket">
        <div class="details">
       ...
       <!--Three-->
      <div  class="one col-lg-4 col-md-12 col-sm-12 p-0">
        <img class="img-fluid" src="assets/imgs/bag2.jpg" alt="">
        <div class="details">
          <h2>50% OFF Bags</h2>
          <button class="text-uppercase">Shop Now</button>
        </div>
  ...
  <section id="Watches" class="my-5">
    ...
    <div class="row mx-auto container-fluid">
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/tshirt.jpg" alt="Shoe">
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
  ...
  <section id="featured" class="my-5">
    ...
    <div class="row mx-auto container-fluid">
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/shoe.jpg" alt="Shoe">
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/shoe2.jpg" alt="Shoe">
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/shoe3.jpg" alt="Shoe">
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/shoe4.jpg" alt="Shoe">
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
