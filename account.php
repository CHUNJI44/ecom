        ...
        <h3 class="font-weight-bold">Account Info</h3>
          ...
          <h3>Change Password</h3>
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" id="account-password" name="confirmPassword" placeholder="Password" required>
					</div>
					<div class="form-group">
						<label for="">Confirm Password</label>
						<input type="password" class="form-control" id="account-password-confirm" name="password" placeholder="Password" required>
					</div>
					<div class="form-group">
      ...
      <?php while($row = $orders->fetch_assoc() ){ ?>
        ...
        <!--<td>
          <div class="product-info">
            <img src="assets/imgs/tshirt.jpg" alt="">
            <div>
